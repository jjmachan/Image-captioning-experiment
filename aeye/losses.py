...
def masked_cross_entropy_1(logits, target, length):
    ...
    print(log_probs_flat.shape, target_flat.shape)
    losses_flat = -torch.gather(log_probs_flat.to(device), dim=1, index=target_flat)
